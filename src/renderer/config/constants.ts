...
export const QUERY_KEYS = {
  ...
  GIT_HEAD_CONTENT: 'GIT_HEAD_CONTENT',
  ...
  GET_CHAT_MESSAGES_WITH_CONTEXT: 'GET_CHAT_MESSAGES_WITH_CONTEXT',

  GET_LINEAGE_UPSTREAM: 'GET_LINEAGE_UPSTREAM',
  GET_LINEAGE_DOWNSTREAM: 'GET_LINEAGE_DOWNSTREAM',
  GET_LINEAGE_FULL: 'GET_LINEAGE_FULL',
  GET_LINEAGE_METADATA: 'GET_LINEAGE_METADATA',
  GET_LINEAGE_CURRENT_MODEL: 'GET_LINEAGE_CURRENT_MODEL',
  // Selected file context
  GET_SELECTED_FILE_CONTEXT: 'GET_SELECTED_FILE_CONTEXT',
  GET_FILE_METADATA: 'GET_FILE_METADATA',
  API_KEY: 'API_KEY',
  USER_PROFILE: 'USER_PROFILE',
  CLOUD_SECRETS: 'CLOUD_SECRETS',
  CLOUD_ACTION_STATUS: 'CLOUD_ACTION_STATUS',
};
