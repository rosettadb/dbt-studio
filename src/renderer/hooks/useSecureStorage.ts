...
const useSecureStorage = () =>
  useMemo(() => {
    ...
    const deleteDatabaseUsername = async (
      projectName: string,
    ): Promise<void> => {
    ...
    const deleteDatabasePassword = async (
      projectName: string,
    ): Promise<void> => {
    ...
    const deleteCloudAzureKey = async (
      connectionName: string,
    ): Promise<void> => {
    ...
    const deleteCloudR2Secret = async (
      connectionName: string,
    ): Promise<void> => {
    ...
    const deleteCloudB2Secret = async (
      connectionName: string,
    ): Promise<void> => {
    ...
    // Generic connection field storage
    const setConnectionField = async (
      field: string,
      value: string,
      connectionName: string,
    ): Promise<void> => {
      await secureStorageService.set(
        `db-${field}-${connectionName}` as any,
        value,
      );
    };
    ...
    const getConnectionField = async (
      ...
      return secureStorageService.get(`db-${field}-${connectionName}` as any);
    };

    const deleteConnectionField = async (
      field: string,
      connectionName: string,
    ): Promise<void> => {
      await secureStorageService.delete(`db-${field}-${connectionName}` as any);
    };
