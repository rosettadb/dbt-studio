...
export type NotebookChannels =
  ...
  | 'notebooks:runAll'
  | 'notebooks:python:lsp:status'
  | 'notebooks:python:lsp:restart'
  | 'notebooks:python:lsp:sync'
  | 'notebooks:python:lsp:request'
  | 'notebooks:python:lsp:close'
  ...
  | 'notebooks:python:list'
  | 'notebooks:python:get'
  | 'notebooks:python:create'
  ...
  | 'notebooks:python:import'
  | 'notebooks:python:export'
  | 'notebooks:python:event'
